<%@ page import="java.util.*, com.airline.model.*" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><%=fList.get(i).getAirplaneExtra().getPlaneMake()+" "+fList.get(i).getAirplaneExtra().getPlaneModel() %></td>
			<td><%=fList.get(i).getAirplaneExtra().getSeatingCapacity() %></td>
